const getCrafts = async () => {
  ...
  const displayDetails = (craft) => {
    ...
    craft.supplies.forEach((ingredient) => {
      const li = document.createElement("li");
      ul.append(li);
      li.innerHTML = ingredient;
    });
  
    const pencil = document.createElement("section");
    pencil.classList.add("pencil");
    craftDetails.append(pencil);
  
    eLink.onclick = showCraftForm;
    dLink.onclick = deleteRecipe.bind(this, craft);
  ...
  const deleteRecipe = async(craft) =>{
